...
base.tar:
	...
	docker run --name fedorawsl library/fedora:31 /bin/bash -c "dnf update -y; rpm -e --nodeps sudo; dnf install -y sudo; dnf clean all; pwconv; grpconv; chmod 0744 /etc/shadow; chmod 0744 /etc/gshadow;"
